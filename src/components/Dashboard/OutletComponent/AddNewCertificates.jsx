...
const AddCertification = () => {
    ...
    return (
        ...
        <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center">Add New Certificate</h2>
        ...
        {/* Upload Brochure */}
        <div>
            <label className="block font-medium mb-2 mt-2">Upload Certificate</label>
            <input
                type="file"
