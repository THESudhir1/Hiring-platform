...
const Loginform = () => {
    ...
    return(
        <div className="min-h-screen flex flex-col justify-center items-center bg-gray-100 p-2">
            ...
            <div className="text-4xl font-bold text-green-700 mb-4 mt-24">
            ...
            <form
                ...
                className="w-full max-w-md bg-gradient-to-r from-green-500 to-green-700 p-8 rounded-lg shadow-lg flex flex-col gap-6 mb-12"
            >
                {/* Email Input */}
