...
const Signupform = () => {
    ...
    return (
        <div className="bg-gray-100 min-h-screen flex flex-col justify-center items-center p-4">
          <p className="text-4xl font-bold text-green-700 mb-12 mt-16">
              Find your Dream Job
          </p>
          <div className="bg-gradient-to-r from-green-500 to-green-700 p-8 rounded-lg shadow-lg w-full max-w-md mb-6">
